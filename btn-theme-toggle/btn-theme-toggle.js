// based on sample https://codepen.io/mserykh/pen/VwWrjWv
...
function changeMoonToSun() {
	if (isMoon) {
		...
		body2.classList.add('dark-theme');
	}
}
...
function changeSunToMoon() {
	if (!isMoon) {
		...
		body2.classList.remove('dark-theme');
	}
}
...
// inspired by Josh Comeau https://www.joshwcomeau.com/
